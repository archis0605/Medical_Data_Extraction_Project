from backend.src.prsr_prescription import PrescriptionParser
import pytest
...
def test_get_direction(doc_1_maria, doc_2_virat, doc_3_empty):
    ...
    assert doc_2_virat.get_field('direction') == 'Use two tablets daily for three months'
    assert doc_3_empty.get_field('direction') == None

def test_get_refill(doc_1_maria, doc_2_virat, doc_3_empty):
    assert doc_1_maria.get_field('refill') == '3'
